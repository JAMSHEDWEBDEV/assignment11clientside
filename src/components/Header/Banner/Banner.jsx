            ...
            <div className="relative mb-10">
                ...
                <div className="absolute top-0 flex items-center  h-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                    <div className='w-full lg:w-1/2 px-8 lg:pl-12 space-y-5'>
                        <h1 className='text-3xl lg:text-6xl text-white font-bold'>Join Worlds Best Marketplace for Workers</h1>
                        ...
                        <button className='btn bg-red-500 border-transparent mr-5 font-bold text-white hover:text-black'>Join Now</button>
